...
(function ($, learun) {
    ...
    var api = {
        bootstraper:  '/WorkFlowModule/WorkFlow/Bootstraper',
        taskinfo:   '/WorkFlowModule/WorkFlow/Taskinfo',
        processinfo:  '/LR_WorkFlowModule/WorkFlow/Processinfo',
        processinfoByMonitor:   '/WorkFlowModule/WfEngine/ProcessinfoByMonitor',
        auditer:  '/LR_WorkFlowModule/WfEngine/Auditer',

        create: '/LR_WorkFlowModule/WfEngine/Create',
        audit:  '/LR_WorkFlowModule/WfEngine/Audit',
    };
