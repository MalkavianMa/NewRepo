...
var shcemeCode = "QXGD";// request('shcemeCode');    // 流程模板编号
var type = request('type');                // 操作类型 0.创建 1.审批 2.重新创建 3.确认阅读 4.加签 100 流程进度查看

var processId = "7058655c-75db-e65d-3b36-f847fc78b035";// request('processId');      // 流程实例主键
var taskId = "53e869d8-dc03-4fac-9f2d-12a113349291";//request('taskId');            // 任务主键
